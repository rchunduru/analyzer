...
(function() {
  var AnalyzerManager, AnalyzerService, AnalyzerServices, EA, EM, MM, SA, SD, SR, async, bunyan, helper, promise, uuid, validate,
  ...
  AnalyzerService = (function(_super) {
    ...
    function AnalyzerService(id, data, config) {
      this.config = config;
      ...
      if (this.data && (this.data.sources != null)) {
        return this.data.sources.map((function(_this) {
          return function(source) {
            ...
            connect = function() {
              return _this.mq.connect(parsedurl.host, parsedurl.port, parsedurl.username, parsedurl.password, 10000, 5);
            };
    ...
    AnalyzerService.prototype.dbConnect = function() {
      ...
      if (this.data && (this.data.output != null)) {
        ...
        return this.eclient = this.em.init("" + parsedurl.host + ":" + parsedurl.port, this.config.loglevel);
      }
    };
    ...
    AnalyzerService.prototype.mailvirusresult = function(message) {
      return helper.parseMessage(message).then((function(_this) {
    ...
    AnalyzerService.prototype.webcontentfilteringtransactions = function(message) {
      helper.parseMessage(message).then((function(_this) {
    ...
    AnalyzerService.prototype.getStats = function(from, to, interval) {
      ...
      return new promise((function(_this) {
        return function(fulfill, reject) {
          ...
          return _this.eclient.search(_this.id, 'transaction.summary', body).then(function(results) {
