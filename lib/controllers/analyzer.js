...
(function() {
  var AnalyzerManager, AnalyzerService, AnalyzerServices, EA, EM, MM, SA, SD, SR, async, bunyan, getNextDay, parseMessage, parseUInt, parsequery, parseurl, postRequest, promise, uuid, validate,
  ...
  AnalyzerService = (function(_super) {
        ...
        return function(message) {
          ...
          switch (msg.header.format.toLowerCase()) {
            ...
            default:
              ...
              return _this.getTransaction(data.timestamp).then(function(content) {
    ...
    AnalyzerService.prototype.getTransaction = function(timestamp) {
      var body, nextday;
      nextday = getNextDay(timestamp);
      if (nextday instanceof Error) {
        return reject(nextday);
      }
      body = {
        query: {
          filtered: {
      ...
      return new promise((function(_this) {
        return function(fulfill, reject) {
            ...
            aggregations: {
              analyzerstats: {
                ...
                aggs: {
                  webTransactions: {
                    sum: {
                      field: "transactions.web.transactions"
                    }
                  },
                  webAVUploadTransactions: {
                    sum: {
                      field: "transactions.webkasperskyupload.transactions"
                    }
                  },
                  webAVDownloadTransactions: {
                    sum: {
                      field: "transactions.webkasperskydownload.transactions"
                    }
                  },
                  webAVUploadViolations: {
                    sum: {
                      field: "transactions.webkasperskyupload.violations"
                    }
                  },
                  webAVDownloadViolations: {
                    sum: {
                      field: "transactions.webkasperskydownload.violations"
                    }
                  },
                  webContentFilteringAllowedTransactions: {
                    sum: {
                      field: "transactions.webcontentfilter.allowedtransactions"
                    }
                  },
                  webContentFilteringViolations: {
                    sum: {
                      field: "transactions.webcontentfilter.violations"
                    }
                  },
                  imapTransactions: {
                    sum: {
                      field: "transactions.mailimap.transactions"
                    }
                  },
                  pop3Transactions: {
                    sum: {
                      field: "transactions.mailpop3.transactions"
                    }
                  },
                  imapViolations: {
                    sum: {
                      field: "transactions.mailimap.violations"
                    }
                  },
                  pop3Violations: {
                    sum: {
                      field: "transactions.mailpop3.violations"
                    }
                  }
                }
              }
          ...
          return _this.em.search(_this.eclient, 'transaction.summary', _this.id, body).then(function(results) {
            ...
            results.aggregations.analyzerstats.buckets.map(function(entry) {
              var statdata;
              statdata = {
                mailVirusViolations: {},
                mailTransactions: {},
              ...
              return response.stats.push(statdata);
            });
