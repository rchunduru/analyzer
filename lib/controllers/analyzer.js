...
(function() {
  var AnalyzerManager, AnalyzerService, AnalyzerServices, EM, MM, SA, SD, SR, async, bunyan, mixof, promise, uuid, validate,
  ...
  AnalyzerManager = (function(_super) {
    ...
    AnalyzerManager.prototype.run = function(config) {
      ...
      connect();
      return this.mq.on('mq.connected', (function(_this) {
        return function(mqclient) {
          ...
          _this.aservices.on('added', function(aservice) {
            aservice.subscription = _this.subscribe(aservice.data.topic, _this.dummyHandler);
